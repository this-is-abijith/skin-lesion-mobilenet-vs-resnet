...
# batch size 8 - ResNet50 heavier, safer for 4GB VRAM
...
for epoch in range(EPOCHS):
    ...
    # checkpoint every epoch - survive crash
    torch.save(model.state_dict(), f"../models/resnet_epoch{epoch+1}.pth")

torch.save(model.state_dict(), "../models/resnet_binary_final.pth")
print("Final model saved to models/resnet_binary_final.pth")